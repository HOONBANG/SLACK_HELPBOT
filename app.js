...
const dmMessages = {
  ...
  btn_oa: '*[:toolbox:OA존 물품]* \n바이트랩 OA존에는 스테이플러, 포스트잇, 투명 파일 등 업무에 필요한 사무용품들이 보관되어 있어요. \n\n업무에 필수적이지만 OA존에 없는 사무용품의 경우 <https://docs.google.com/spreadsheets/d/1fpPfYgudlI0uDqAn3r9wR2HYkrmZysZaz7fyPqs-bIQ/edit?gid=10814374#gid=10814374|비품 신청 워크플로우nst BlockDM = () => ([
  {
    type: 'section',
    text: {
      type: 'plain_text',
...
const dmMessages = {
  ...
  btn_attendance_dm: '*[:clock10:근태 문의]* \n바이트랩은 9시-10시 사이에 자유롭게 출퇴근 시간을 선택하고 8시간 근무하는 *"시차 출퇴근제"*를 통해 유연 근무를 하고 있어요. \n\n사무실 입구의 출입 인식기를 통해 flex에 출퇴근 시간을 기록하니 출근, 퇴근 시에 잊지 말고 꼭 기록을 남겨주세요! \n\n👶🏼자녀 육아 시, 08시 30분-10시 30분까지 확대된 유연 근무가 적용돼요! \n\n🏃🏼외근을 나가시고 현장에서 퇴근하신다면, 외근 나가실 때 출입 인식기에서 퇴근을 태그해주시고 flex에서 외근을 등록해주세요! 잠깐 외근 가셨다 돌아오는 일정이라면 외근 신청만 올려주시면 됩니다.', 
  btn_vacation_dm: '*[:palm_tree:연차 문의]* \n연차는 1주일 전 미리 플렉스를 통해 등록해주시고 팀원들에게 미리 공유해주세요! \n연차는 사유를 묻지 않으나, 부득이한 당일 연차라면 반드시 사유를 남기신 뒤에 워크플로우를 상신해주시면 됩니다.:smile: \n자세한 연차 제도 안내는 아래 노션 팀 생활 엿보기 페이지에서 볼 수 있어요! \n<https://www.notion.so/12934579dc0180c89fd4ee682628098b#12934579dc0180a787bddb3d2090f1b4|바이트랩 팀 생활 엿보기>',
  btn_oa: '*[:toolbox:OA존 물품]* \n바이트랩 OA존에는 스테이플러, 포스트잇, 투명 파일 등 업무에 필요한 사무용품들이 보관되어 있어요. \n\n업무에 필수적이지만 OA존에 없는 사무용품의 경우 <https://flex.team/workflow/archive/my?tab=in-progress&workflow-action=create&workflow-template-key=fd1367a24e2743e3ad18e5f112cd50de|비품 신청 워크플로우>를 작성해주시면 됩니다. 😊',
